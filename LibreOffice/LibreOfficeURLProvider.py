...
#http://download.documentfoundation.org/libreoffice/stable/4.2.7/mac/x86/LibreOffice_4.2.7_MacOS_x86_langpack_de.dmg
#http://donate.libreoffice.org/de/dl/mac-x86_64/4.2.7/de/LibreOffice_4.2.7_MacOS_x86-64.dmg
...
class LibreOfficeURLProvider(Processor):
    ...
    def create_url(self):
        ...
        self.output("XXX - Base: %s" % base_url_start)
        self.output("XXX - Requ: %s" % request_string)
